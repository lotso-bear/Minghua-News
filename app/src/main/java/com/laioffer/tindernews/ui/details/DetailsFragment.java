package com.laioffer.tindernews.ui.details;
...
import com.laioffer.tindernews.databinding.FragmentDetailsBinding;
...
public class DetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Picasso.get().load(article.urlToImage).resize(2560, 1440).into(binding.detailsImageView);
    }
